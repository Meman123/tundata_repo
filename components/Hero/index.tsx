      ...
      <div className={styles.layout}>
        <div className={styles.text}>
          ...
          <p className={styles.subtitle}>
            Transformamos{' '}
            <span className={styles.highlight}>datos públicos</span> de Duitama
            y <span className={styles.highlight}>facilitamos</span> su
            visualización para impulsar una ciudadanía{' '}
            <span className={styles.highlight}>más informada</span> y promover
            un gobierno{' '}
            <span className={styles.highlight}>más transparente</span>.
          </p>
